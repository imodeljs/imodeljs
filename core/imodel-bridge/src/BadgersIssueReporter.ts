...
export class BadgersIssueReporter implements BridgeIssueReporter {
  ...
  public constructor(contextId: string, iModelId: GuidString, activityId: string, fileId: string, stagingDir?: any, operationType?: string,
    ...
    this._stagingDir = stagingDir ?? os.tmpdir();
